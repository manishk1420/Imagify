...
const Testimonials = () => {
  return (
    ...
    viewport={{once:true}}
    className='flex flex-col items-center justify-center my-20 pu-12'>
      <h1 className='text-3xl sm:text-4xl font-semibold mb-2'> Customer Testimonials</h1>
        <p className='text-gray-500 mb-12'>What Our Users Are Saying</p>
            ...
            {testimonialsData.map((testimonail,index)=>(
                <div key={index}
                className='bgwhite/20 p-12 rounded-lg shadow-md border w-80 m-auto cursor-pointer hover:scale-[1.02] transition-all'>
